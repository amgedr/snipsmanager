...
<!--
  @(#) $Id: rss1html.xsl,v 1.1 2006/08/29 23:10:09 mlemos Exp $
  -->
...
<div name="escaped" class="item-description"><xsl:value-of select="rss:description" disable-output-escaping="yes"/></div>
<hr />
</xsl:for-each>
</ul>
